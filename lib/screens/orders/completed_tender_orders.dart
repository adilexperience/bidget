...
class CompletedTenderOrders extends StatefulWidget {
  const CompletedTenderOrders({Key key}) : super(key: key);

  @override
  _CompletedTenderOrdersState createState() => _CompletedTenderOrdersState();
}

class _CompletedTenderOrdersState extends State<CompletedTenderOrders> {
